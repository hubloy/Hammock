...
export class NoticeUI extends Component {
...
NoticeUI.defaultProps = { // Here we set default values for some of our props
	duration: 4000,
	showDismiss: true,
	onDismissClick: null,
};

NoticeUI.propTypes = { // And define our propTypes
