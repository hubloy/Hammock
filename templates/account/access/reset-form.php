 ...
 *
 * This template can be overridden by copying it to yourtheme/hubloy_membership/account/access/reset-form.php.
 *
...
<div class="hubloy_membership-account-access-reset <?php echo $extra_classes; ?>">
	<h4><?php _e( 'Reset your account password', 'hubloy_membership' ); ?></h4>
	<form name="lostpasswordform" class="hubloy_membership-ajax-form" id="lostpasswordform" method="post">
		...
		?>
		<p class="submit">
			<button name="wp-submit" id="wp-submit" class="button button-primary button-large"><?php esc_attr_e( 'Get New Password', 'hubloy_membership' ); ?></button>
		</p>
		<?php
