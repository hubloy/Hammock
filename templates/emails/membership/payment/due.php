 ...
 *
 * This template can be overridden by copying it to yourtheme/memberships-by-hubloy/emails/membership/payment/due.php.
 *
...
<p><?php printf( esc_html_e( 'Your payment to invoice %1$s is due. Manage your account at : %2$s', 'memberships-by-hubloy' ), esc_html( $object->invoice->invoice_id ), make_clickable( esc_url( hubloy_membership_get_account_url() ) ) ); ?></p>
<?php
