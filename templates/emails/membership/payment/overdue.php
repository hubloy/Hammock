 ...
 *
 * This template can be overridden by copying it to yourtheme/hubloy_membership/emails/membership/payment/overdue.php.
 *
...
<p><?php printf( esc_html_e( 'Your payment to invoice %1$s is overdue. Manage your account at : %2$s', 'hubloy_membership' ), esc_html( $object->invoice->invoice_id ), make_clickable( esc_url( hubloy_membership_get_account_url() ) ) ); ?></p>
<?php
