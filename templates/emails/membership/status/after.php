...
<p><?php printf( esc_html_e( 'Your subscription to %1$s has ended. Manage your account at : %2$s', 'hubloy_membership' ), esc_html( $object->membership ), make_clickable( esc_url( hubloy_membership_get_account_url() ) ) ); ?></p>
<?php
